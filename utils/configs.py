...
def set_configs(parser):
    ...
    parser.add_argument('--path_to_e2vflow', type=str, 
                        help='Path to the pretrained CISTA-Flow model (trained with normal events)') 
    ...
    parser.add_argument('--flow_epoch', default=20, type=int, help='Number of epochs for training FlowNet (Rec I)')
    parser.add_argument('--rec_epoch', default=5, type=int, help='Number of epochs for training CISTA (Pred Flow)')
    ...
    parser.add_argument('--is_forward_flow', dest='is_forward_flow', action='store_true')
    parser.set_defaults(is_forward_flow=False)
    ...
    parser.add_argument('--warp_mode', type=str, default="forward")
